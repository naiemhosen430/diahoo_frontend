...
export default function CreatePost(props) {
  ...
  return (
    <div className='backdrop-blur-xl bg-b py-20 fixed w-screen h-screen' onClick={props.closecreatepostbox}>
      <div className='w-3/5 p-4 m-auto rounded-xl bg-slate-900' onClick={handleSubboxClick}>
        <div>
            <input 
              className='w-full bg-black rounded-xl my-2 p-2 text-white' type="text"
        ...
        {showvideobox && (
          <div className='py-4'>
          <label className='text-lg text-rose-200' htmlFor="videourl">Past your youtube video url</label>
          <input 
            className='w-full bg-black rounded-xl my-2 p-2 text-white' type="text" 
        ...
        {showimagebox && (
          <div className='py-4'>
          <label className='text-lg text-rose-200' htmlFor="image">Choose your image</label>
          <input 
        ...
        <div>
            <button className='text-center text-zinc-50 bg-slate-800 w-full p-2 my-2' type="button" onClick={props.closecreatepostbox}>Cencel</button>
        </div>
      </div>
    </div>
  );
