...
export default function PostHeader({ postOwnerName, postOwnerPicture, postedtime }) {
  ...
  return (
    <div className='flex items-center justify-center space-2 p-4'>
      <div className='w-1/6 flex items-center justify-center'>
        <img className='h-10 w-10 block rounded-full' src={postOwnerPicture} alt="no image" />
      </div>
      <div className='w-4/6'>
