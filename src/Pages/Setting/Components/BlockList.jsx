...
export default function BlockList({closeSettingBlocking}) {
  return (
    <>
        <ul>
          <li className='text-2xl text-white py-2 my-2 px-4 cursor-pointer rounded shadow' onClick={closeSettingBlocking}><IoMdArrowBack /></li>
        </ul>
        <div>
            ...
            <div>
                <div className='flex items-center p-4 py-2 shadow-md'>
                    ...
                    <button className='text-white w-1/6 border rounded bg-black p-1 text-center' type="button">Unblock</button>
                </div>
            </div>
        </div>
    </>
